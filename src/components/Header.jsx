  ...
  return (
    <div className=' bg-gradient-to-t from-bg from-10% to-second to-99% flex flex-col lg:flex-row md:flex-row xl:flex-row lg:pt-10'>  
        <div className='pt-20 lg:px-20 px-10 lg:w-1/2 md:w-1/2'>
            ...
            <p className='text-xs text-light font-light mb-2 lg:text-sm md:text-sm xl:text-base'>I am an Informatics Engineering student at UIN SGD Bandung. Even though I have no experience in the professional world, I am interested in and learning about frontend developers. Previously, I had been involved in web development projects during my studies. I am very enthusiastic about applying my knowledge and skills in the world of work!</p>
